...
// Set email variables
$email_to = 'maze.faze5@address.com';
...
<form action="contact.php" method="post" id="comments_form">
     ...
     <div class="row">
     <div class="label">Your Name</div><!---end lable---->
     <div class="input">
     <input type="text" id="fullname" class="detail" name="fullname" value="<?php echo isset($_POST['fullname'])? $_POST['fullname'] : ''; ?>" /><?php if(in_array('fullname', $validation)): ?><span class="error"><?php echo $error_messages['fullname']; ?></span><?php endif; ?>
     
     </div><!---end input---->
     <div class="context">e.g mazefaze5 or larry nash</div> <!----end context--->
     </div>
    <!----end row---->
     
     
     <div class="row">
     <div class="label">Your Email Address</div> <!---end lable---->
     <div class="input">
     <input type="text" id="email" class="detail" name="email" value="<?php echo isset($_POST['email'])? $_POST['email'] : ''; ?>" />
<?php if(in_array('email', $validation)): ?><span class="error"><?php echo $error_messages['email']; ?></span><?php endif; ?>

     </div> <!---end input---->
     <div class="context">yout email will not be shared with anyone or receive spam</div><!----end context--->
     </div> <!----end row---->
...
<div class="submit">
<input type="submit" id="submit" name="submit" value="Send Message" /></div> <!-------end submit----->
